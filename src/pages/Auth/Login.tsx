      ...
      <section className="pl-[10rem] flex flex-wrap">
        <div className="mr-[4rem] mt-[5rem]">
          ...
          <form className="container w-[40rem]" onSubmit={submitHandler}>
            ...
            <button disabled={isLoading} type="submit" className="bg-pink-500 hover:bg-pink-400 text-white px-4 py-2 rounded cursor-pointer my-[1rem]">{isLoading ? "Signing...":"Sign In"}</button>
            {isLoading && <Loader/>}
          </form>
          <div className="mt-4">
