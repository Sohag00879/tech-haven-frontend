...
import { useDeleteUserMutation } from "../../redux/features/admin/user/deleteUserApi";
import { useGetUsersQuery } from "../../redux/features/admin/user/getUsersApi";
import { useUpdateUserMutation } from "../../redux/features/admin/user/updateUserApi";
...
const UserList = () => {
  ...
  const toggleEdit = (id:string | null, username:string, email:string) => {
