    ...
    <div className="mt-3">
      <div>
        ...
        <p className="text-center ml-20 mr-2 mt-2">
          {" "}
          We're excited to unveil our latest collection, where style meets
          innovation. From cutting-edge designs to timeless classics, our new
          arrivals are crafted to elevate your look and inspire your lifestyle
        </p>
      </div>
